...
const cardData: BentoCardProps[] = [
  ...
  },
  {
    color: '#1a1a2e',
    title: 'Dashboard',
    description: 'Centralized data view and monitoring',
    label: 'Overview'
  },
  {
    color: '#0f3460',
    ...
    const handleMouseMove = (e: MouseEvent) => {
      ...
      cards.forEach(card => {
       ...
       gsap.to(spotlightRef.current, {
         ...
         duration: targetOpacity > 0 ? 0.3 : 0.6,
         ease: 'power2.out'
       });
    };
      ...
      <BentoCardGrid   gridRef={gridRef}>
        <div className="card-responsive ">
          {cardData.map((card, index) => {
            ...
            const cardStyle = {
              backgroundColor: card.color || '#1a1a2e',
            ...
            if (enableStars) {
              return (
                ...
                >
                                     <div className="card__header flex justify-start items-center gap-3 relative text-white mb-6">
                     <span className="card__label text-sm font-medium px-4 py-2 rounded-full bg-white/20 backdrop-blur-sm">
                       {card.label}
                     </span>
                   </div>
                   <div className="card__content flex flex-col relative text-white">
                     ...
                     <p
                       className={`card__description text-base leading-6 opacity-80 ${textAutoHide ? 'text-clamp-2' : ''}`}
                     >
                       {card.description}
                     </p>
                   </div>
            ...
            return (
              ...
              >
                 ...
                 <div className="card__content flex flex-col relative text-white">
                   ...
                   <p className={`card__description text-base leading-6 opacity-80 ${textAutoHide ? 'text-clamp-2' : ''}`}>
                     {card.description}
                   </p>
                 </div>
              </div>
